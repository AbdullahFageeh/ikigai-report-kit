...
def geocode_place(place: str) -> dict[str, Any]:
    ...
    request = Request(
        ...
        headers={"User-Agent": "ikigai-report-kit/1.0 (https://github.com/AbdullahFageeh/ikigai-report-kit)"},
    )
    try:
...
def main() -> int:
    ...
    parser.add_argument("--place", help="birth place, for example: Jeddah, Saudi Arabia")
